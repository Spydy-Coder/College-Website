  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8800/studentidentity/${studentId}`,
        {
          method: "POST",
          headers: {
          ...
          <div className="container mt-5 ms-5  mx-auto d-flex flex-column justify-content-center align-items-center ">
            ...
            <div className="d-flex flex-column justify-content-center gap-3 mt-4">
              <div className="flex-item">
                <h2 className="h4">Student Information</h2>
              </div>
              <div className="flex-item">
                  ...
                  <div className="form-group col-auto mb-3">
                    ...
                    <div className="col-sm-8">
                      ...
                      >
                        ...
                        <option value="1">Reappear in Class 9</option>
                        <option value="2">
                          Student comes from Other Recognised School
                        </option>
                      </select>
                    </div>
                  </div>
